        ...
        <div className="grid grid-cols-[repeat(auto-fit,minmax(158px,1fr))] gap-3 p-4">
          {isLoading ? (
            ...
            newArrivals.map((product) => (
              ...
              >
                <div className="aspect-[3/4] w-full relative bg-gray-100 dark:bg-gray-800 rounded-xl overflow-hidden">
                ...
                <div>
                  <p className="text-[#0d141b] dark:text-white text-base font-medium leading-normal line-clamp-1">{product.name}</p>
                  <p className="text-[#4c739a] dark:text-slate-400 text-sm font-normal leading-normal">EGP {product.price.toFixed(2)}</p>
                </div>
              </Link>
            ))
          )}
