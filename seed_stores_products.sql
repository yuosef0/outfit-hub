...
BEGIN
  ...
  INSERT INTO products (store_id, name, description, price, category, gender_filter, image_urls, stock_quantity, is_active) VALUES
  ...
  (store1_id, 'Elegant Evening Gown', 'Sophisticated evening gown for special occasions', 1299.99, 'Clothing', 'Women', ARRAY['https://images.unsplash.com/photo-1566174053879-31528523f8ae?w=500&h=700&fit=crop'], 10, true);
  ...
  (store2_id, 'Formal Oxford Shoes', 'Classic oxford shoes for business and formal events', 799.99, 'Shoes', 'Men', ARRAY['https://images.unsplash.com/photo-1614252235316-8c857d38b5f4?w=500&h=700&fit=crop'], 15, true),
  (store2_id, 'Casual Sneakers', 'Comfortable sneakers for daily wear', 449.99, 'Shoes', 'Unisex', ARRAY['https://images.unsplash.com/photo-1595950653106-6c9ebd614d3a?w=500&h=700&fit=crop'], 35, true);
  ...
  (store3_id, 'Leather Belt', 'Premium leather belt with silver buckle', 199.99, 'Accessories', 'Unisex', ARRAY['https://images.unsplash.com/photo-1624222247344-550fb60583b2?w=500&h=700&fit=crop'], 25, true),
  (store3_id, 'Silk Scarf', 'Luxurious silk scarf with elegant pattern', 249.99, 'Accessories', 'Women', ARRAY['https://images.unsplash.com/photo-1601924994987-69e26d50dc26?w=500&h=700&fit=crop'], 18, true);

  -- Insert Products for Store 4: Style Studio
  INSERT INTO products (store_id, name, description, price, category, gender_filter, image_urls, stock_quantity, is_active) VALUES
  (store4_id, 'Business Suit', 'Professional business suit with modern cut', 1499.99, 'Clothing', 'Men', ARRAY['https://images.unsplash.com/photo-1594938298603-c8148c4dae35?w=500&h=700&fit=crop'], 12, true),
  (store4_id, 'Cocktail Dress', 'Stylish cocktail dress for evening events', 899.99, 'Clothing', 'Women', ARRAY['https://images.unsplash.com/photo-1566174053879-31528523f8ae?w=500&h=700&fit=crop'], 14, true);

  -- Insert Products for Store 5: Urban Threads
  INSERT INTO products (store_id, name, description, price, category, gender_filter, image_urls, stock_quantity, is_active) VALUES
  (store5_id, 'Graphic T-Shirt', 'Bold graphic t-shirt with street art design', 199.99, 'Clothing', 'Unisex', ARRAY['https://images.unsplash.com/photo-1521572163474-6864f9cf17ab?w=500&h=700&fit=crop'], 50, true),
  (store5_id, 'Cargo Pants', 'Comfortable cargo pants with multiple pockets', 449.99, 'Clothing', 'Unisex', ARRAY['https://images.unsplash.com/photo-1624378439575-d8705ad7ae80?w=500&h=700&fit=crop'], 30, true);

  -- Insert Products for Store 6: Luxury Watches
  INSERT INTO products (store_id, name, description, price, category, gender_filter, image_urls, stock_quantity, is_active) VALUES
  (store6_id, 'Minimalist Watch', 'Elegant minimalist watch with leather strap', 799.99, 'Watches', 'Unisex', ARRAY['https://images.unsplash.com/photo-1524592094714-0f0654e20314?w=500&h=700&fit=crop'], 12, true),
  (store6_id, 'Chronograph Watch', 'Sophisticated chronograph with multiple functions', 1599.99, 'Watches', 'Men', ARRAY['https://images.unsplash.com/photo-1522312346375-d1a52e2b99b3?w=500&h=700&fit=crop'], 8, true),
  (store6_id, 'Diamond Watch', 'Luxury watch with diamond accents', 2999.99, 'Watches', 'Women', ARRAY['https://images.unsplash.com/photo-1611652022419-a9419f74343a?w=500&h=700&fit=crop'], 5, true);

  -- Insert Products for Store 7: Bag Boutique
  INSERT INTO products (store_id, name, description, price, category, gender_filter, image_urls, stock_quantity, is_active) VALUES
  (store7_id, 'Designer Backpack', 'Stylish and functional designer backpack', 649.99, 'Bags', 'Unisex', ARRAY['https://images.unsplash.com/photo-1553062407-98eeb64c6a62?w=500&h=700&fit=crop'], 18, true),
  (store7_id, 'Leather Handbag', 'Premium leather handbag with gold hardware', 899.99, 'Bags', 'Women', ARRAY['https://images.unsplash.com/photo-1584917865442-de89df76afd3?w=500&h=700&fit=crop'], 15, true),
  (store7_id, 'Travel Duffel Bag', 'Spacious duffel bag perfect for travel', 549.99, 'Bags', 'Unisex', ARRAY['https://images.unsplash.com/photo-1553062407-98eeb64c6a62?w=500&h=700&fit=crop'], 20, true);

  -- Insert Products for Store 8: Gem Palace
  INSERT INTO products (store_id, name, description, price, category, gender_filter, image_urls, stock_quantity, is_active) VALUES
  (store8_id, 'Diamond Ring', 'Exquisite diamond ring with platinum setting', 3999.99, 'Jewelry', 'Women', ARRAY['https://images.unsplash.com/photo-1605100804763-247f67b3557e?w=500&h=700&fit=crop'], 6, true),
  (store8_id, 'Gold Bracelet', 'Elegant 18k gold bracelet', 1299.99, 'Jewelry', 'Women', ARRAY['https://images.unsplash.com/photo-1611591437281-460bfbe1220a?w=500&h=700&fit=crop'], 10, true),
  (store8_id, 'Pearl Earrings', 'Classic pearl earrings with gold studs', 599.99, 'Jewelry', 'Women', ARRAY['https://images.unsplash.com/photo-1535632066927-ab7c9ab60908?w=500&h=700&fit=crop'], 12, true);
